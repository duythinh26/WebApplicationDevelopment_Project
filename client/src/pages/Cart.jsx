                ...
                <div className="bottom__info">
                    <div className="bottom__product">
                        <div className="bottom__product-detail">
                            <img className='cart__product--img' src="https://hips.hearstapps.com/vader-prod.s3.amazonaws.com/1614188818-TD1MTHU_SHOE_ANGLE_GLOBAL_MENS_TREE_DASHERS_THUNDER_b01b1013-cd8d-48e7-bed9-52db26515dc4.png?crop=1xw:1.00xh;center,top&resize=480%3A%2A" alt="" />
                            <div id="detail">
